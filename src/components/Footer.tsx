...
const Footer = () => {
  return (
    <footer className="bg-[#090D2F] text-white py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="#flex-caps" className="hover:text-[#F5821F] transition-colors">STEC-F Flex Caps</a></li>
              <li><a href="#coatings" className="hover:text-[#F5821F] transition-colors">PVC Coatings</a></li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>
                ...
                <a href="mailto:sales@shrinktech.com" className="hover:text-[#F5821F] transition-colors">
